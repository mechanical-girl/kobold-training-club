from ktc.api import get_list_of_environments, get_list_of_sizes, get_list_of_monster_types, get_list_of_challenge_ratings
...
def test_type_list_returns_list():
    expected = type(list())
    actual = type(get_list_of_monster_types())
    assert expected == actual
...
def test_type_list_returns_unique_list_of_monster_types():
    ...
    actual = get_list_of_monster_types()
...
def test_cr_list_returns_list():
    expected = type(list())
    actual = type(get_list_of_challenge_ratings())
    assert expected == actual
...
def test_cr_list_returns_unique_list_of_challenge_ratings():
    ...
    actual = get_list_of_challenge_ratings()
