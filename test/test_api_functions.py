...
def test_monster_list_returns_full_list_if_no_parameters_passed():
    expected = [['Aarakocra', '1/4', 'Medium', 'Humanoid', 'neutral good', 'Monster Manual: 12, Princes of the Apocalypse Online Supplement v1.0: 6'], ['Aarakocra Captain', '3', 'Medium', 'Humanoid', 'neutral good', 'Monster Module: 3'], ['Aarakocra Priest of Aerdrie', '8', 'Medium', 'Humanoid', 'neutral good', 'Monster Module: 4'], ['Aarakocra Sharpshooter', '1/2', 'Medium', 'Humanoid', 'neutral good', 'Monster Module: 3'], ['Aaztar-Ghola', '4', 'Medium', 'Humanoid', 'chaotic evil', 'Fifth Edition Foes: 5'], ['Abjurer', '9', 'Medium', 'Humanoid', 'any', "Volo's Guide to Monsters: 209"], ['Aboleth', '10', 'Large', 'Aberration', 'lawful evil', 'Monster Manual: 13, Princes of the Apocalypse Online Supplement v1.0: 6'], ['Aboleth Sovereign', '16', 'Huge', 'Aberration', 'lawful evil', 'Monster Module: 5'], ['Abominable Beauty', '11', 'Medium', 'Fey', 'neutral evil', 'Tome of Beasts: 11'], ['Abominable Sloth', '6', 'Huge', 'Beast', 'unaligned', 'Primeval Thule Campaign Setting: 220'],
                ['Abominable Yeti', '9', 'Huge', 'Monstrosity', 'chaotic evil', 'Monster Manual: 306'], ['Accursed Defiler', '4', 'Medium', 'Undead', 'neutral evil', 'Tome of Beasts: 12'], ['Acolyte', '1/4', 'Medium', 'Humanoid', 'any', 'Basic Rules v1: 53, HotDQ supplement: 4, Monster Manual: 342'], ['Adherer', '2', 'Medium', 'Aberration', 'lawful evil', 'Fifth Edition Foes: 6'], ['Adult Black Dragon', '14', 'Huge', 'Dragon', 'chaotic evil', 'Monster Manual: 88, Princes of the Apocalypse Online Supplement v1.0: 7'], ['Adult Blue Dracolich', '17', 'Huge', 'Undead', 'lawful evil', 'Monster Manual: 84'], ['Adult Blue Dragon', '16', 'Huge', 'Dragon', 'lawful evil', 'HotDQ supplement: 4, Monster Manual: 91'], ['Adult Brass Dragon', '13', 'Huge', 'Dragon', 'chaotic good', 'Monster Manual: 105'], ['Adult Bronze Dragon', '15', 'Huge', 'Dragon', 'lawful good', 'Monster Manual: 108, Princes of the Apocalypse Online Supplement v1.0: 7'], ['Adult Cave Dragon', '16', 'Huge', 'Dragon', 'neutral evil', 'Tome of Beasts: 125']]
...
def test_monster_list_returns_good_multiple_constraint_list():
    expected = ['Crabman', 'Dark Triton', 'Fanged Sea Serpent', 'Giant Clam', 'Giant Electric Catfish', 'Giant Moray Eel', 'Giant Octopus', 'Giant Sea Horse', 'Giant Seahorse', 'Giant Water Beetle', 'Gray Nisp', 'Gulper Eel',
                'Hippocampus', 'Hunter Shark', 'Kelpie', 'Merfolk', 'Merrow', 'Monstrous Crayfish', 'Mummy of the Deep', 'Plesiosaurus', 'Reef Shark', 'Spitting Sea Serpent', 'Strangle Weed', 'Swarm of Quippers', 'Thalasskoptis', 'Tortoise']
    parameters = {"sizes": ["sizes_Medium", "sizes_Large"],
